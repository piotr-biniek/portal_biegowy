...
public class ThemeSwitcherBean implements Serializable {
    ...
    public String getTheme() {
        if (isLoggedUzer()) {//pomyslec jak zrobic to inaczej ciby bazy nie pytac wciaz
            return aplicationController.getTheme();
        }
        return theme;
    }
...
//        setGp(new GuestPreferences()); // persistent class
            ...
            setTheme("south-street"); // starting theme
    ...
    public void saveTheme() {
        ...
        aplicationController.saveTheme(theme);
